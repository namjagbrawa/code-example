...
package com.bingo.code.example.good;

import java.net.InetAddress;
import java.net.InetSocketAddress;
import java.net.UnknownHostException;

import static com.bingo.code.example.good.SessionProtocol.HTTP;
import static com.bingo.code.example.good.SessionProtocol.HTTPS;
